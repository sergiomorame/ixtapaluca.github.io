...
lyr_Positron_0.setVisible(true);lyr_Ixtapaluca_1.setVisible(true);lyr_colonias_2.setVisible(true);lyr_Incidencias_3.setVisible(true);
var layersList = [lyr_Positron_0,lyr_Ixtapaluca_1,lyr_colonias_2,lyr_Incidencias_3];
