...
map.getView().fit([-11018590.619989, 2183531.589132, -10976612.464941, 2203966.207677], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua Ixtapaluca</h2>';
        return titleElement;
    })(),
